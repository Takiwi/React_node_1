...
- Improved Authentication Flow: The registration process now includes client-side error handling and redirects users to the login page upon successful registration.
- Private Routes: Implemented a private route system to protect authenticated routes from public access.
